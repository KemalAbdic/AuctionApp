...
function Terms() {
    ...
    return (
        <div className="terms-container">
            ...
            <div className="terms-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vitae lacinia mi,
                nec pellentesque
                dolor.
            ...
            <div className="terms-text">Ut faucibus purus risus, sed blandit nisl porta vel. Maecenas urna nisl,
            ...
            <h6>Some title here</h6>
            <div className="terms-text">Sed vitae convallis ex. Sed a nulla a nibh malesuada iaculis. Aenean accumsan at
                dui eget blandit.
                Nullam
